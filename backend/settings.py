...
def get_settings() -> dict:
    ...
    # Default to "true" for backward compatibility (old behavior)
    # In production, this should be explicitly set to "false"
    lab_mode_enabled_str = os.getenv("LAB_MODE_ENABLED", "true").lower()
